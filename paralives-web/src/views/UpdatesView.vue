<template>
  <article class="updates-page">
    <PageHero
      ...
      :title="pageH1"
      eyebrow="What changed in EA"
      variant="roadmap"
      lead="Paralives hit Steam Early Access on May 25, 2026. We copied the public day-one versus during-EA mode lists here so you can plan saves — always trust paralives.com and your patch notes if anything disagrees."
      stamp-src="/images/update-01.webp"
      stamp-alt="Paralives Steam Early Access launch milestone"
      stamp-caption="EA launch"
      :breadcrumbs="updatesCrumbs"
    />
...
<section class="updates-block" aria-labelledby="timeline-heading">
        ...
        <section class="updates-block" aria-labelledby="status-heading">
          ...
          <ul class="updates-status">
            ...
            <li>
              Track day-one vs later-in-EA systems with the official mode lists above and your in-game
              patch notes after each Steam update.
            </li>
            <li>
...
<section class="updates-block" aria-labelledby="roadmap-heading">
          <header class="updates-section-head">
            ...
            <p>
              ...
              Paralives Studio’s published development roadmap and news posts. We group the major mode
              lists on this page so you can plan saves without alt-tabbing — the dev site stays the source
              of truth.
            </p>
          </header>
        </section>
<p class="updates-disclaimer">
          Paralives Guide is unofficial — we are players, not Paralives Studio. This page cannot replace
          developer announcements, Steam purchase details, or in-game patch notes. When in doubt, trust the
          studio’s latest post and what you see in your installed build.
        </p>
      </div>
    </div>
  </article>
...
const pageH1 = getPageH1('updates')
const updatesCrumbs = [{ to: '/', label: 'Home' }, { label: 'Roadmap' }]
